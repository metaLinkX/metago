...
// AdminMemberPostColumns defines and stores column names for the table admin_member_post.
type AdminMemberPostColumns struct {
	MemberId string // 管理员ID
	PostId   string // 岗位ID
}

// adminMemberPostColumns holds the columns for the table admin_member_post.
