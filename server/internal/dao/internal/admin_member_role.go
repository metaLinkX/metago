...
// AdminMemberRoleDao is the data access object for the table admin_member_role.
...
// AdminMemberRoleColumns defines and stores column names for the table admin_member_role.
type AdminMemberRoleColumns struct {
	MemberId string // 管理员ID
	RoleId   string // 角色ID
}

// adminMemberRoleColumns holds the columns for the table admin_member_role.
