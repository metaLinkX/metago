...
// AdminRoleCasbinDao is the data access object for the table admin_role_casbin.
...
// AdminRoleCasbinColumns defines and stores column names for the table admin_role_casbin.
...
// adminRoleCasbinColumns holds the columns for the table admin_role_casbin.
