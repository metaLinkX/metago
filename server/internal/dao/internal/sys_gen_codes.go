...
// SysGenCodesDao is the data access object for the table sys_gen_codes.
...
// SysGenCodesColumns defines and stores column names for the table sys_gen_codes.
...
// sysGenCodesColumns holds the columns for the table sys_gen_codes.
